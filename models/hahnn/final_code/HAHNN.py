...
class HAHNN:
    ...
    def prepare_embeddings(self, embd_size=200, embd_location=False):
    ...
    def prepare(self, no_of_labels=2, embd_size=200, embd_location=False):
        ...
        embd_w = self.prepare_embeddings(embd_size, embd_location)
        ...
        embd_term_series = Embedding(
            ...
            mask_zero=False,
            name=term_embeddings, )(input_shape)
        ...
        term_att = Model(
            input_shape, Att(name=term_attention)(fnn_for_term))
        ...
        txt_att = Att(name=sen_attention)(fnn_for_sen)
            ...
            LambdaCallback(
                on_epoch_end=lambda epoch, logs: self.store_t_model(
                    os.path.join(tokenizer_dir,
                                 self.retrieve_term_splitter_f_title(base_name)), epoch))
        ]
